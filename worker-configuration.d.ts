/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 32eb4cee54e33c90383f419e107b5fdf)
...
interface __BaseEnv_Env {
	...
	AI: Ai;
	AI_GATEWAY_ID: "triage-gateway";
	LOCAL_MODEL: string;
	OLLAMA_URL: string;
	ADMIN_KEY: string;
	SUPPORT_KEY: string;
	TICKET_SESSION: DurableObjectNamespace<import("./src/index").TicketSession>;
	ROUTER_AGENT: DurableObjectNamespace<import("./src/index").RouterAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TicketSession" | "RouterAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "LOCAL_MODEL" | "OLLAMA_URL" | "ADMIN_KEY" | "SUPPORT_KEY">> {}
}
